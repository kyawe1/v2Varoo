<header class='px-2 py-1 primaryly'>
    ...
    <div class='navbar navbar-expand-lg navbar-light  my-2'>
        ...
        <div class='collapse navbar-collapse' id='collapseable'>
            <ul class='navbar-nav ms-auto'>
                <li class='nav-item mx-2'><a href='/home' class='nav-link text-white'>Home</a></li>
                <li class='nav-item mx-2'><a href='/about' class='nav-link text-white'>About</a></li>
